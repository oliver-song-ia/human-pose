...
class SAM3DBodyEstimator:
    ...
    def process_one_image(
        ...
        self.output = None
        self.prev_prompt = []
        # Fixed-shape realtime inference should reuse PyTorch's CUDA allocator.
        # Emptying it every frame forces synchronization/reallocation and adds
        # latency jitter. Keep an opt-in escape hatch for memory diagnostics.
        if os.environ.get("MHR_EMPTY_CACHE_EACH_FRAME", "0") == "1":
            try:
