...
# Stage1 output directories — adjust to your local paths
# e.g., /path/to/outputs_RICH/samples
STAGE1_DIRS = [
    str(PROJECT_DIR / 'eval/outputs_RICH/samples'),
    str(PROJECT_DIR / 'eval/outputs_RICH_extra/samples'),
]
...
def main():
    ...
    mhr_faces = np.load(str(MHR2SMPL_DIR / 'data/mhr_faces.npy'))
