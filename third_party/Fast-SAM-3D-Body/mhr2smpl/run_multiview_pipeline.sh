...
# ================================================================
# cd /path/to/Fast-SAM-3D-Body && bash mhr2smpl/run_multiview_pipeline.sh 2>&1 | tee mhr2smpl/pipeline.log
# Pipeline:
...
# ============================================================
RUN_STEP0=1                        # SAM-3D-Body inference
RUN_STEP1=1                        # Data collection + merge
RUN_STEP2=1                        # Multi-view training
RUN_STEP3=1                        # Evaluation
...
# e.g., source /path/to/miniforge3/etc/profile.d/conda.sh
...
# e.g., /path/to/MHR/tools/mhr_smpl_conversion
MHR_CONV_DIR="${PROJECT_DIR}/eval/MHR/tools/mhr_smpl_conversion"
# e.g., /path/to/.pixi/bin/pixi
PIXI="$(command -v pixi)"
# e.g., /path/to/MHR/pyproject.toml
MANIFEST="${PROJECT_DIR}/eval/MHR/pyproject.toml"
PIXI_RUN="${PIXI} run --manifest-path ${MANIFEST} python"

# e.g., /path/to/miniforge3/envs/fast_sam_3d_body
CONDA_ENV="$(conda info --base)/envs/fast_sam_3d_body"
CONDA_PYTHON="${CONDA_ENV}/bin/python"

SMPL_MODEL="${DATA_DIR}/SMPL_NEUTRAL.pkl"
SMPL_MODEL_REL="./data/SMPL_NEUTRAL.pkl"

# Dataset paths — adjust to your local data locations
# e.g., /path/to/dataset/EMDB/data, /path/to/dataset/3DPW, etc.
EMDB_DATA="${PROJECT_DIR}/eval/dataset/EMDB/data"
DPW_DATA="${PROJECT_DIR}/eval/dataset/3DPW"
EMDB_SAMPLES="${DATA_DIR}/outputs_EMDB/samples"
DPW_SAMPLES="${DATA_DIR}/outputs_3dpw/samples"
RICH_SAMPLES="${PROJECT_DIR}/eval/outputs_RICH/samples"
AIST_VIDEO_DIR="${PROJECT_DIR}/eval/dataset/AIST/videos"
AIST_DIR="${PROJECT_DIR}/eval/dataset/AIST"
